...
class produtoSinais(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.analog_sig_source_x_2 = analog.sig_source_f(samp_rate, analog.GR_COS_WAVE, 100000, 2, 0, 10)
    ...
    def set_samp_rate(self, samp_rate):
        ...
        self.low_pass_filter_0.set_taps(firdes.low_pass(1, self.samp_rate, 11000, 1000, window.WIN_HAMMING, 6.76))
